...
* Скачать и установить [Node.js](https://nodejs.org/dist/v25.2.1/node-v25.2.1-x64.msi "Установить Node.Js"). Для проверки введите в консоль `npm -v` и `node -v`
* Скачать source-код в папку, выполните в ней консольную команду npm i
